...
public interface IsiLangListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterCmddecisao(IsiLangParser.CmddecisaoContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#cmddecisao}.
	 * @param ctx the parse tree
	 */
	void exitCmddecisao(IsiLangParser.CmddecisaoContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterExprComparacao(IsiLangParser.ExprComparacaoContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#exprComparacao}.
	 * @param ctx the parse tree
	 */
	void exitExprComparacao(IsiLangParser.ExprComparacaoContext ctx);
	/**
	 * Enter a parse tree produced by {@link IsiLangParser#termoComparacao}.
	 * @param ctx the parse tree
	 */
	void enterTermoComparacao(IsiLangParser.TermoComparacaoContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#termoComparacao}.
	 * @param ctx the parse tree
	 */
	void exitTermoComparacao(IsiLangParser.TermoComparacaoContext ctx);
}